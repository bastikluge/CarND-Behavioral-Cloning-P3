...
# param[in] file_path     path from which csv-file and image data shall be loaded
# param[in] column_index  index of column from which the images shall be loaded
# param[in] angle_offset  offset angle applied to angle value from csv-file
